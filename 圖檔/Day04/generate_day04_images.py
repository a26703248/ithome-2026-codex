...
def cover():
    ...
    text(d, (70, 70), "DAY 04 · 需求釐清", 34, CYAN, True)
...
def hidden_gaps():
    ...
    save(im, "day04-02-hidden-gaps.png")
...
def four_buckets():
    ...
    save(im, "day04-03-four-buckets.png")
...
def three_rounds():
    ...
    save(im, "day04-04-three-rounds.png")
...
def acceptance():
    ...
    save(im, "day04-05-acceptance.png")
