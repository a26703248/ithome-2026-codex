...
def cover():
    ...
    draw_text(draw, (100, 92), "DAY 27｜從 0 到 1 的 AI 可驗證工作流試煉", 27, "#77D2C4", True)
...
def inventory_table():
    ...
    footer(draw, 2)
    save(image, "day27-02-inventory.png")
...
def governance_hexagon():
    ...
    footer(draw, 3)
    save(image, "day27-03-governance-hexagon.png")
...
def dev_flow():
    ...
    footer(draw, 4)
    save(image, "day27-04-dev-flow.png")
...
def copyright_layers():
    ...
    footer(draw, 5)
    save(image, "day27-05-copyright-layers.png")
