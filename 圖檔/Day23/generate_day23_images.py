...
def cover():
    ...
    label(draw, (105, 90), "DAY 23 · 進階整合工作流", 38, "#5EEAD4", True)
...
def six_layers():
    ...
    save(image, "day23-02-six-layers.png")
...
def code_review():
    ...
    save(image, "day23-03-code-review.png")
...
def evidence_matrix():
    ...
    save(image, "day23-04-evidence-matrix.png")
...
def review_comparison():
    ...
    save(image, "day23-05-review-comparison.png")
