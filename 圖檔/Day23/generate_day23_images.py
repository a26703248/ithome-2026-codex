...
def cover():
    ...
    label(draw, (105, 90), "DAY 23 · 前人砍樹後人曝曬", 38, "#5EEAD4", True)
...
def source_map():
    ...
    save(image, "day23-02-source-map.png")
...
def readme_before_after():
    ...
    save(image, "day23-03-readme-before-after.png")
...
def command_verification():
    ...
    save(image, "day23-04-command-verification.png")
...
def comment_comparison():
    ...
    save(image, "day23-05-comment-comparison.png")
