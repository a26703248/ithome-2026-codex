...
def cover():
    ...
    label(draw, (70, 70), "DAY 10 · CODEX", 34, CYAN, True)
...
def agent_loop():
    ...
    save(image, "day10-02-agent-loop.png")
...
def boundary():
    ...
    save(image, "day10-03-boundary.png")
...
def work_log():
    ...
    save(image, "day10-04-work-log.png")
...
def evidence():
    ...
    save(image, "day10-05-evidence.png")
