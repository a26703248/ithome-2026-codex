...
def cover():
    ...
    text(d, (70, 70), "DAY 06 · 系統設計", 34, CYAN, True)
...
def constraints():
    ...
    save(im, "day06-02-constraints.png")
...
def selected_flow():
    ...
    save(im, "day06-04-selected-flow.png")
...
def decision_record():
    ...
    save(im, "day06-05-decision-record.png")
