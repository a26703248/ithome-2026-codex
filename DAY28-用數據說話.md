...
![Day 28 封面：「感覺變快了」不是可採用的導入結論](https://raw.githubusercontent.com/a26703248/ithome-2026-codex/main/%E5%9C%96%E6%AA%94/Day28/day28-01-cover.png)

Day 27 算完一次任務的總成本後，PM 把試辦階段的導入報告草稿發給我看，裡面一句話是「複核人員回饋感覺變快了，建議擴大試用」。我問了兩個問題：變快是跟什麼比？品質有沒有跟著掉？PM 答不上來，手上只有 AI 生成時間，沒算複核與返工，也沒有「以前」的對照資料，頂多把 Day 01 那張基準線卡片翻出來充數。但那張卡片任務範圍自選、難度不固定，只寫了「原本完成時間」的粗略描述，拿來比較時間，跟拿不同難度的任務硬比一樣站不住腳。需求書第七節問的「如何量測是否真的縮短撰寫時間、草稿被大幅修改或否決的比例」，答案不能只靠一句主觀印象。
...
![效率指標與品質護欄：五項指標的定義、資料來源與對應護欄行動](https://raw.githubusercontent.com/a26703248/ithome-2026-codex/main/%E5%9C%96%E6%AA%94/Day28/day28-02-metrics-guardrail.png)
...
![配對前後測設計：同一份規格，人工與 Codex 各實作一次，環境與驗收條件固定](https://raw.githubusercontent.com/a26703248/ithome-2026-codex/main/%E5%9C%96%E6%AA%94/Day28/day28-03-pre-post-design.png)
...
![Day 01 基準線卡片與 Day 28 配對資料集的差異：任務範圍、驗收條件、樣本數](https://raw.githubusercontent.com/a26703248/ithome-2026-codex/main/%E5%9C%96%E6%AA%94/Day28/day28-04-day01-vs-day28.png)
...
![結果對應決策矩陣：速度與品質的四種組合，本次結果落在「只提升速度」象限](https://raw.githubusercontent.com/a26703248/ithome-2026-codex/main/%E5%9C%96%E6%AA%94/Day28/day28-05-decision-matrix.png)
...
配對前後測加一個彙總工具，把「感覺變快了」換成可追溯的數字：速度提升四成，複核負擔、修改否決比例、引用錯誤數卻都變差，落在「補強複核驗收」而非「擴大試用」。Day 29 會回看系列裡沒有成功的案例，把需求、範圍與驗收上的失敗整理成可重複使用的教訓。

## 參考資料

- `案例/AI輔助生成系統-需求書.md`
- [`程式碼/DAY28/docs/baseline-log.md`](./%E7%A8%8B%E5%BC%8F%E7%A2%BC/DAY28/docs/baseline-log.md)：配對前後測與批次比較原始資料
